...
/**
 *model to E_SmallScaleA2  entity
 */
use application\models\Entities\entities_salt\E_SmallScaleaA2;

class M_SmallScaleA2  extends MY_Model {
		...
		if ($this -> input -> post()) {//check if a post was made
		  ...
		  // print(($key." ".$val)).'<br \>';
			...
			//iodization centre name obtained from the session variable => 'affiliation'
			 ...
			 $this -> theForm = new \models\Entities\entities_salt\E_SmallScaleA2(); //create an object of the model
				...
				$this -> theForm -> setContentOfIodine($this->elements[$i]["contentOfIodine"]);
				$this -> theForm -> setAmountUsed($this->elements[$i]["amountUsed"]);
