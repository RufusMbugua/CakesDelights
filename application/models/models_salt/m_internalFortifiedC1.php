 ...
 */
use application\models\Entities\entities_salt\E_IntFortifiedC1;
		...
		if ($this -> input -> post()) {//check if a post was made
		  ...
		  // print(($key." ".$val)).'<br \>';
			...
			//iodization centre name obtained from the session variable => 'affiliation'
			 ...
			 $this -> theForm = new \models\Entities\entities_salt\E_IntFortifiedC1(); //create an object of the model
