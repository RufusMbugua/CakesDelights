 ...
 */
use application\models\Entities\entities_maize\E_Maize_IntFort_A1;

class M_Maize_InternalFort_A1  extends MY_Model {
		...
		if ($this -> input -> post()) {//check if a post was made
		  ...
		  // print(($key." ".$val)).'<br \>';
			...
			$premix=$this->em->getRepository('models\Entities\E_PremixType')
			 ...
			 $this -> theForm = new \models\Entities\entities_maize\E_Maize_InternalFort_A1(); //create an object of the model
				...
				$this -> theForm ->setProductionObservation($this->elements['productionObservation']);
				...
				$this -> theForm ->setMicronutrientLevels($this->elements['micronutrientLevels']);
				$this -> theForm ->setMicronutrientObservation($this->elements['micronutrientObservation']);
